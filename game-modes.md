...
- `gameMode.id=72000060`, `gameMode.name=Overtime_Ladder` was observed in five `riverRacePvP` battles on 2026-09-14 with
  `deckSelection=collection`. Treat it as a rotating River Race mode label; the name alone does not establish its exact
  overtime rules.
